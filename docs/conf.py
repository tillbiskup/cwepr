...
project = "cwepr"
copyright = (
    "2020- Mirjam Schröder, 2018/19 Pascal Kirchner, 2018– Till Biskup"
)
...
latex_documents = [
    (master_doc, "cwepr.tex", "cwepr Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "cwepr", "cwepr Documentation", [author], 1)]
